...
$database->query('SELECT customkill, COUNT(customkill) AS total FROM smalllog WHERE customkill NOT IN(0,3,5,7,9,10,13,15,18,21,24,25,28,29,33,38,39,53,54,61,75,72,82,98)
