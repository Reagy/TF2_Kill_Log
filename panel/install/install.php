...
if ($_GET['query'] == 'weapons') {
	...
	$weapons = array(
	  ...
	  array('index' => NULL,'name' => 'Environment','weapon' => 'world','slot' => NULL,'class' => 'Scout, Sniper, Soldier, Demoman, Medic, Heavy, Pyro, Spy, Engineer','image' => 'images/weaponicons/Killicon_skull.png'),
	  ...
	  array('index' => NULL,'name' => 'Suicide','weapon' => 'player','slot' => NULL,'class' => 'Scout, Sniper, Soldier, Demoman, Medic, Heavy, Pyro, Spy, Engineer','image' => 'images/weaponicons/Killicon_skull.png'),
