...
if (isset($_POST['type']) && $_POST['type'] == 'getplayermge') {
    ...
    $columns = array(
        array(
            'db'        => 'mgemod_duels.winner',
            'dt'        => 'winner',
            'field'     => 'winner'
        ),
        array(
            'db'        => 'mgemod_duels.loser',
            'dt'        => 'loser',
            'field'     => 'loser'
        ),
        array(
            'db'        => 'mgemod_duels.winnerscore',
            'dt'        => 'winnerscore',
            'field'     => 'winnerscore'
        ),
        array(
            'db'        => 'mgemod_duels.loserscore',
            'dt'        => 'loserscore',
            'field'     => 'loserscore'
        ),
        array(
            'db'        => 'mgemod_duels.winlimit',
            'dt'        => 'winlimit',
            'field'     => 'winlimit'
        ),
        array(
        ...
        array(
            'db'        => 'mgemod_duels.gametime',
            'dt'        => 'gametime',
            'field'     => 'gametime',
            'as'        => 'gametime'
        ),
        array(
            'db'        => 'mgemod_duels.mapname',
            'dt'        => 'mapname',
            'field'     => 'mapname',
            'as'        => 'mapname'
        ),
        array(
            'db'        => 'mgemod_duels.arenaname',
            'dt'        => 'arenaname',
            'field'     => 'arenaname',
            'as'        => 'arenaname'
        )
    ...
    $extraCondition = "(`winner` = '".$_POST['id']."') OR (`loser` = '".$_POST['id']."')";
    $joinQuery = "FROM `mgemod_duels` INNER JOIN (`playerlog` as a, `playerlog` as v) ON (mgemod_duels.`winner` = a.`auth` AND mgemod_duels.`loser` = v.`auth`)";
